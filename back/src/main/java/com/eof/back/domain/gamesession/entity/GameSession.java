...
public class GameSession extends BaseEntity {
     ...
     */
    @Builder
    private GameSession(String roomName, User host, QuizSet quizSet, Integer maxQuestions, Integer maxPlayers, GameSessionStatus status) {
     ...
     */
    public static GameSession of(String roomName, User host, QuizSet quizSet, Integer maxQuestions, Integer maxPlayers) {
