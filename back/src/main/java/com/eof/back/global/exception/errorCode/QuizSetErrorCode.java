 ...
 *
 * <p>상황에 대한 코드, 클라이언트로의 응답 코드 및 메시지를 가지며, 그 명명 규칙은 문서를 참조해야 합니다. 해당 {@code QuizSetErrorCode} 는 {@link
 * com.eof.back.global.exception.exceptions.QuizSetException QuizSetException}에서 사용되며, <br>
